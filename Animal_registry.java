...
public class Animal_registry {
    public class FileEditor {
        public static void updateSection(int lineNumber, String newSection) {
            ...
            String fileName = "animal_registry.txt";
    ...
    public static void readFile(int nomer) {
        try (BufferedReader br = new BufferedReader(new FileReader("animal_registry.txt"))) {
            String line;
            int i = 0;
            while ((line = br.readLine()) != null) {
                ...
                System.out.println("№ " + i + " Животое: " + elements[0] + " Имя: " + elements[1] + " Дата рождения: "
                        + elements[2] + " Команды: " + elements[3]);
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public static void add(String animalType) {
        ...
        try (Counter counter = new Counter();
                BufferedWriter writer = new BufferedWriter(new OutputStreamWriter(
                        new FileOutputStream("animal_registry.txt", true), "UTF-8"))) {
